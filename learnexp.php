...
<DOCTYPE html> 
    ...
    <body>
        ...
        <section class="video-section">
            <article class="video-container">
                <a href="#" class="thumbnail" data-duration="10.00">
                    <img class="thumbnail-image" href="C:\xampp\htdocs\sample java boi\video\javaboilogo.png" > 
                </a>
            ...
            <article class="video-container">
                <a href="#" class="thumbnail" data-duration="10.00">
                    <img class="thumbnail-image"  type="png" href="C:\xampp\htdocs\sample java boi\video\javaboilogo.png" > 
                </a>
                <div class="video-bottom-section">
                    <a href="#">
                        <div class="video-detail">
      ...
      <div class="quizz-section">
        <a href="quizzexpertL1.php" class="quizz-button">
